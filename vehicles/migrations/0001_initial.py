    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('current_location', models.CharField(choices=[('at sea', 'At Sea'), ('warehouse', 'Warehouse'), ('branch', 'Branch'), ('service shop', 'Service Shop'), ('finance sale', 'Finance Sale'), ('corporate sale', 'Corporate Sale'), ('wholesale', 'Wholesale'), ('retail', 'Retail'), ('damaged', 'Damaged'), ('missing', 'Missing')], default='at sea', max_length=20)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('current_location', models.CharField(choices=[('at sea', 'At Sea'), ('warehouse', 'Warehouse'), ('branch', 'Branch'), ('finance sale', 'Finance Sale'), ('corporate sale', 'Corporate Sale'), ('wholesale', 'Wholesale'), ('retail', 'Retail'), ('damaged', 'Damaged'), ('missing', 'Missing')], default='at sea', max_length=20)),
