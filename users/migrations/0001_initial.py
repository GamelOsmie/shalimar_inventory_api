    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(blank=True, choices=[('Super Admin', 'Super Admin'), ('Admin', 'Admin'), ('Import Officer', 'Import Officer'), ('Tracking Officer', 'Tracking Officer'), ('Warehouse Officer', 'Warehouse Officer'), ('Branch Officer', 'Branch Officer'), ('Service Shop Officer', 'Service Shop Officer'), ('Website Manager', 'Website Manager')], default=None, max_length=50, null=True)),
                ('workplace', models.CharField(blank=True, default='General Office', max_length=50, null=True)),
