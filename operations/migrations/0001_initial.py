    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('supply_code', shortuuid.django_fields.ShortUUIDField(alphabet='1234567890', editable=False, length=8, max_length=10, prefix='WS')),
                ...
                ('container', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='warehouse_supply', to='operations.container')),
                ...
                ('warehouse', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='warehouse_supply', to='units.warehouse')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('warehouse', models.OneToOneField(on_delete=django.db.models.deletion.PROTECT, related_name='warehouses', to='units.warehouse')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('commercial_invoice', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.PROTECT, related_name='commercial_invoices', to='operations.commercialinvoice')),
                ('proforma_invoice', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.PROTECT, related_name='proforma_invoices', to='operations.proformainvoice')),
            ],
            options={
                'ordering': ['-created_at'],
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.UUIDField(default=uuid.uuid4, editable=False, primary_key=True, serialize=False, unique=True)),
                ('branch', models.OneToOneField(on_delete=django.db.models.deletion.PROTECT, related_name='branches', to='units.branch')),
                ('spare_parts_damaged', models.ManyToManyField(blank=True, related_name='branch_spare_parts_missing', to='vehicles.sparepart')),
                ('spare_parts_in_stock', models.ManyToManyField(blank=True, related_name='branch_spare_parts_in_stock', to='vehicles.sparepart')),
                ('vehicles_damaged', models.ManyToManyField(blank=True, related_name='branch_vehicles_missing', to='vehicles.vehicle')),
                ('vehicles_in_stock', models.ManyToManyField(blank=True, related_name='branch_vehicles_in_stock', to='vehicles.vehicle')),
            ],
            options={
                'ordering': [django.db.models.functions.text.Lower('branch__name')],
            },
        ),
    ]
